...
const Payment = () => {
  ...
  const commissionRate = 0.15;
  const commission = parseFloat(totalPrice) * commissionRate; // Parse totalPrice as a float
  const deliveryFee = 50;
  const finalPrice =
    deliveryOption === "delivery"
      ? parseFloat(totalPrice) + commission + deliveryFee // Parse totalPrice here too
      : parseFloat(totalPrice) + commission; // And here
  ...
  const handlePayment = async (event) => {
    ...
    const orderData = {
      ...
      items: items.map((item) => ({
        itemId: item.id,
        quantity: item.quantity,
        price: parseFloat(item.price), // Parse item.price here
      })),
    };
      ...
      <div className="row justify-content-center">
        <div className="col-md-8 col-lg-6">
          <div className="card shadow-sm p-4">
            ...
            <h3 className="mb-3">Items in Cart:</h3>
            <ul className="list-group mb-3">
              ...
              {deliveryOption === "delivery" && (
                <li className="list-group-item d-flex justify-content-between">
                  ...
                  <strong>{deliveryFee} Birr</strong>
                </li>
              )}
              ...
              <div className="mb-3">
                ...
                <div className="form-check">
                  ...
                  <label
                    ...
                    htmlFor="deliveryOptionDelivery"
                  >
                    Delivery
                  </label>
                </div>
                <div className="form-check">
                  <input
                    ...
                    onChange={(e) => setDeliveryOption(e.target.value)}
                    required
                    id="deliveryOptionGoAndBuy"
                  />
                  <label
                    className="form-check-label"
                    htmlFor="deliveryOptionGoAndBuy"
                  >
                    Go and Buy It (Self Pickup)
                  </label>
                </div>
              </div>
